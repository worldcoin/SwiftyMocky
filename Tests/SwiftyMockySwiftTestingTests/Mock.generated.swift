...
open class STDataStoreMock: STDataStore, Mock {
    ...
    public var isReady: Bool {
		get {	invocations.append(.p_isReady_get); return __p_isReady ?? givenGetterValue(.p_isReady_get, "STDataStoreMock - stub value for isReady was not defined") }
	}
	private var __p_isReady: (Bool)?

    public var name: String {
		get {	invocations.append(.p_name_get); return __p_name ?? givenGetterValue(.p_name_get, "STDataStoreMock - stub value for name was not defined") }
