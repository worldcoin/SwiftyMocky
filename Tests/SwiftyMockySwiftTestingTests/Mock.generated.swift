...
// MARK: - STAuthenticator

open class STAuthenticatorMock: STAuthenticator, Mock {
    ...
    open func authenticate(for key: String) throws {
        addInvocation(.m_authenticate__for_key(Parameter<String>.value(`key`)))
		let perform = methodPerformValue(.m_authenticate__for_key(Parameter<String>.value(`key`))) as? (String) -> Void
		perform?(`key`)
		do {
		    _ = try methodReturnValue(.m_authenticate__for_key(Parameter<String>.value(`key`))).casted() as Void
    ...
    open func authenticate() throws {
        addInvocation(.m_authenticate)
		let perform = methodPerformValue(.m_authenticate) as? () -> Void
		perform?()
		do {
		    _ = try methodReturnValue(.m_authenticate).casted() as Void
		} catch MockError.notStubed {
			// do nothing
		} catch {
		    throw error
    ...
    fileprivate enum MethodType {
        case m_authenticate__for_key(Parameter<String>)
        case m_authenticate

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_authenticate__for_key(let lhsKey), .m_authenticate__for_key(let rhsKey)):
            ...
            case (.m_authenticate, .m_authenticate): return .match
            default: return .none
            }
        }
        ...
        func intValue() -> Int {
            switch self {
            case let .m_authenticate__for_key(p0): return p0.intValue
            case .m_authenticate: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_authenticate__for_key: return ".authenticate(for:)"
            case .m_authenticate: return ".authenticate()"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func authenticate(for key: Parameter<String>, willThrow: Error...) -> MethodStub {
            return Given(method: .m_authenticate__for_key(`key`), products: willThrow.map({ StubProduct.throw($0) }))
        }
        public static func authenticate(for key: Parameter<String>, willProduce: (StubberThrows<Void>) -> Void) -> MethodStub {
            let willThrow: [Error] = []
			let given: Given = { return Given(method: .m_authenticate__for_key(`key`), products: willThrow.map({ StubProduct.throw($0) })) }()
			let stubber = given.stubThrows(for: (Void).self)
			willProduce(stubber)
			return given
        }
        public static func authenticate(for key: Parameter<String>, willReturn: Void) -> MethodStub {
            return Given(method: .m_authenticate__for_key(`key`), products: [.return(())])
        }
        public static func authenticate(willThrow: Error...) -> MethodStub {
            return Given(method: .m_authenticate, products: willThrow.map({ StubProduct.throw($0) }))
        }
        public static func authenticate(willProduce: (StubberThrows<Void>) -> Void) -> MethodStub {
            let willThrow: [Error] = []
			let given: Given = { return Given(method: .m_authenticate, products: willThrow.map({ StubProduct.throw($0) })) }()
			let stubber = given.stubThrows(for: (Void).self)
			willProduce(stubber)
			return given
        }
        public static func authenticate(willReturn: Void) -> MethodStub {
            return Given(method: .m_authenticate, products: [.return(())])
        }
    }
    ...
    public struct Verify {
        ...
        public static func authenticate(for key: Parameter<String>) -> Verify { return Verify(method: .m_authenticate__for_key(`key`))}
        public static func authenticate() -> Verify { return Verify(method: .m_authenticate)}
    }
    ...
    public struct Perform {
        ...
        public static func authenticate(for key: Parameter<String>, perform: @escaping (String) -> Void) -> Perform {
            return Perform(method: .m_authenticate__for_key(`key`), performs: perform)
        }
        public static func authenticate(perform: @escaping () -> Void) -> Perform {
            return Perform(method: .m_authenticate, performs: perform)
        }
    }
...
open class STDataStoreMock: STDataStore, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, fileID: String = #fileID, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    public var isReady: Bool {
		get {	addInvocation(.p_isReady_get); return __p_isReady ?? givenGetterValue(.p_isReady_get, "STDataStoreMock - stub value for isReady was not defined") }
	}
	private var __p_isReady: (Bool)?

    public var name: String {
		get {	addInvocation(.p_name_get); return __p_name ?? givenGetterValue(.p_name_get, "STDataStoreMock - stub value for name was not defined") }
...
// MARK: - STSimpleService

open class STSimpleServiceMock: STSimpleService, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, fileID: String = #fileID, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
...
open class STTransformerMock: STTransformer, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, fileID: String = #fileID, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
