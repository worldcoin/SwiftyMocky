...
open class AMassiveTestProtocolMock: AMassiveTestProtocol, Mock, StaticMock {
    ...
    public var nonOptionalClosure: () -> Void {
		get {	addInvocation(.p_nonOptionalClosure_get); return __p_nonOptionalClosure ?? givenGetterValue(.p_nonOptionalClosure_get, "AMassiveTestProtocolMock - stub value for nonOptionalClosure was not defined") }
		set {	addInvocation(.p_nonOptionalClosure_set(.value(newValue))); __p_nonOptionalClosure = newValue }
	}
	private var __p_nonOptionalClosure: (() -> Void)?

    public var optionalClosure: (() -> Int)? {
		get {	addInvocation(.p_optionalClosure_get); return __p_optionalClosure ?? optionalGivenGetterValue(.p_optionalClosure_get, "AMassiveTestProtocolMock - stub value for optionalClosure was not defined") }
		set {	addInvocation(.p_optionalClosure_set(.value(newValue))); __p_optionalClosure = newValue }
	}
	private var __p_optionalClosure: (() -> Int)?

    public var implicitelyUnwrappedClosure: (() -> Void)! {
		get {	addInvocation(.p_implicitelyUnwrappedClosure_get); return __p_implicitelyUnwrappedClosure ?? optionalGivenGetterValue(.p_implicitelyUnwrappedClosure_get, "AMassiveTestProtocolMock - stub value for implicitelyUnwrappedClosure was not defined") }
		set {	addInvocation(.p_implicitelyUnwrappedClosure_set(.value(newValue))); __p_implicitelyUnwrappedClosure = newValue }
	}
	private var __p_implicitelyUnwrappedClosure: (() -> Void)?


    public static var optionalClosure: (() -> Int)? {
		get {	AMassiveTestProtocolMock.addInvocation(.p_optionalClosure_get); return AMassiveTestProtocolMock.__p_optionalClosure ?? optionalGivenGetterValue(.p_optionalClosure_get, "AMassiveTestProtocolMock - stub value for optionalClosure was not defined") }
		set {	AMassiveTestProtocolMock.addInvocation(.p_optionalClosure_set(.value(newValue))); AMassiveTestProtocolMock.__p_optionalClosure = newValue }
	}
    ...
    static public func verify(_ method: StaticVerify, count: Count = Count.moreOrEqual(to: 1), file: StaticString = #file, fileID: String = #fileID, line: UInt = #line) {
        let fullMatches = matchingCalls(method, file: file, fileID: fileID, line: line)
        let success = count.matches(fullMatches)
        let assertionName = method.method.assertionName()
        let feedback: String = {
    ...
    static private func matchingCalls(_ method: StaticMethodType, file: StaticString?, fileID: String?, line: UInt?) -> [StaticMethodType] {
        matcher.set(file: file, fileID: fileID, line: line)
        defer { matcher.clearFileAndLine() }
...
open class ComplicatedServiceTypeMock: ComplicatedServiceType, Mock {
    ...
    public var youCouldOnlyGetThis: String {
		get {	addInvocation(.p_youCouldOnlyGetThis_get); return __p_youCouldOnlyGetThis ?? givenGetterValue(.p_youCouldOnlyGetThis_get, "ComplicatedServiceTypeMock - stub value for youCouldOnlyGetThis was not defined") }
	}
...
open class DateSortableMock: DateSortable, Mock {
    ...
    public var date: Date {
		get {	addInvocation(.p_date_get); return __p_date ?? givenGetterValue(.p_date_get, "DateSortableMock - stub value for date was not defined") }
	}
...
open class FailsWithKeywordArgumentsMock: FailsWithKeywordArguments, Mock {
    ...
    public var `throw`: Error {
		get {	addInvocation(.p_throw_get); return __p_throw ?? givenGetterValue(.p_throw_get, "FailsWithKeywordArgumentsMock - stub value for `throw` was not defined") }
		set {	addInvocation(.p_throw_set(.value(newValue))); __p_throw = newValue }
	}
...
open class ProtocolWithAssociatedTypeMock<T>: ProtocolWithAssociatedType, Mock where T: Sequence {
    ...
    public var sequence: T {
		get {	addInvocation(.p_sequence_get); return __p_sequence ?? givenGetterValue(.p_sequence_get, "ProtocolWithAssociatedTypeMock - stub value for sequence was not defined") }
	}
...
open class ProtocolWithAssociatedType2Mock<ValueType>: ProtocolWithAssociatedType2, Mock where ValueType: StringConvertibleType {
    ...
    public var property: String {
		get {	addInvocation(.p_property_get); return __p_property ?? givenGetterValue(.p_property_get, "ProtocolWithAssociatedType2Mock - stub value for property was not defined") }
	}
...
open class ProtocolWithGenericConstraintsMock<ContainedType>: ProtocolWithGenericConstraints, Mock {
    ...
    public var value: ContainedType {
		get {	addInvocation(.p_value_get); return __p_value ?? givenGetterValue(.p_value_get, "ProtocolWithGenericConstraintsMock - stub value for value was not defined") }
	}
...
open class ProtocolWithInitializersMock: ProtocolWithInitializers, Mock {
    ...
    public var param: Int {
		get {	addInvocation(.p_param_get); return __p_param ?? givenGetterValue(.p_param_get, "ProtocolWithInitializersMock - stub value for param was not defined") }
	}
	private var __p_param: (Int)?

    public var other: String {
		get {	addInvocation(.p_other_get); return __p_other ?? givenGetterValue(.p_other_get, "ProtocolWithInitializersMock - stub value for other was not defined") }
	}
...
open class ProtocolWithPropertiesMock: ProtocolWithProperties, Mock, StaticMock {
    ...
    public var name: String {
		get {	addInvocation(.p_name_get); return __p_name ?? givenGetterValue(.p_name_get, "ProtocolWithPropertiesMock - stub value for name was not defined") }
		set {	addInvocation(.p_name_set(.value(newValue))); __p_name = newValue }
	}
	private var __p_name: (String)?

    public var email: String? {
		get {	addInvocation(.p_email_get); return __p_email ?? optionalGivenGetterValue(.p_email_get, "ProtocolWithPropertiesMock - stub value for email was not defined") }
		set {	addInvocation(.p_email_set(.value(newValue))); __p_email = newValue }
	}
	private var __p_email: (String)?

    public var internalProperty: InternalType {
		get {	addInvocation(.p_internalProperty_get); return __p_internalProperty ?? givenGetterValue(.p_internalProperty_get, "ProtocolWithPropertiesMock - stub value for internalProperty was not defined") }
		set {	addInvocation(.p_internalProperty_set(.value(newValue))); __p_internalProperty = newValue }
	}
	private var __p_internalProperty: (InternalType)?


    public static var name: String {
		get {	ProtocolWithPropertiesMock.addInvocation(.p_name_get); return ProtocolWithPropertiesMock.__p_name ?? givenGetterValue(.p_name_get, "ProtocolWithPropertiesMock - stub value for name was not defined") }
		set {	ProtocolWithPropertiesMock.addInvocation(.p_name_set(.value(newValue))); ProtocolWithPropertiesMock.__p_name = newValue }
	}
	private static var __p_name: (String)?

    public static var defaultEmail: String? {
		get {	ProtocolWithPropertiesMock.addInvocation(.p_defaultEmail_get); return ProtocolWithPropertiesMock.__p_defaultEmail ?? optionalGivenGetterValue(.p_defaultEmail_get, "ProtocolWithPropertiesMock - stub value for defaultEmail was not defined") }
		set {	ProtocolWithPropertiesMock.addInvocation(.p_defaultEmail_set(.value(newValue))); ProtocolWithPropertiesMock.__p_defaultEmail = newValue }
	}
...
open class ProtocolWithStaticMembersMock: ProtocolWithStaticMembers, Mock, StaticMock {
    ...
    public static var staticProperty: String {
		get {	ProtocolWithStaticMembersMock.addInvocation(.p_staticProperty_get); return ProtocolWithStaticMembersMock.__p_staticProperty ?? givenGetterValue(.p_staticProperty_get, "ProtocolWithStaticMembersMock - stub value for staticProperty was not defined") }
	}
...
open class ProtocolWithSubscriptsMock: ProtocolWithSubscripts, Mock {
    ...
    public var something: Any {
		get {	addInvocation(.p_something_get); return __p_something ?? givenGetterValue(.p_something_get, "ProtocolWithSubscriptsMock - stub value for something was not defined") }
		set {	addInvocation(.p_something_set(.value(newValue))); __p_something = newValue }
	}
...
open class ProtocolWithWhereAfterDefinitionMock<T>: ProtocolWithWhereAfterDefinition, Mock where T: Sequence, T.Element: Equatable {
    ...
    public var sequence: T {
		get {	addInvocation(.p_sequence_get); return __p_sequence ?? givenGetterValue(.p_sequence_get, "ProtocolWithWhereAfterDefinitionMock - stub value for sequence was not defined") }
	}
	private var __p_sequence: (T)?
...
open class ShouldAllowNoStubDefinedMock: ShouldAllowNoStubDefined, Mock, StaticMock {
    ...
    public var property: Int? {
		get {	addInvocation(.p_property_get); return __p_property ?? optionalGivenGetterValue(.p_property_get, "ShouldAllowNoStubDefinedMock - stub value for property was not defined") }
	}
	private var __p_property: (Int)?


    public static var property: Int? {
		get {	ShouldAllowNoStubDefinedMock.addInvocation(.p_property_get); return ShouldAllowNoStubDefinedMock.__p_property ?? optionalGivenGetterValue(.p_property_get, "ShouldAllowNoStubDefinedMock - stub value for property was not defined") }
	}
...
open class SimpleProtocolThatInheritsOtherProtocolsMock: SimpleProtocolThatInheritsOtherProtocols, Mock {
    ...
    public var property: String {
		get {	addInvocation(.p_property_get); return __p_property ?? givenGetterValue(.p_property_get, "SimpleProtocolThatInheritsOtherProtocolsMock - stub value for property was not defined") }
		set {	addInvocation(.p_property_set(.value(newValue))); __p_property = newValue }
	}
	private var __p_property: (String)?

    public var weakProperty: AnyObject! {
		get {	addInvocation(.p_weakProperty_get); return __p_weakProperty ?? optionalGivenGetterValue(.p_weakProperty_get, "SimpleProtocolThatInheritsOtherProtocolsMock - stub value for weakProperty was not defined") }
		set {	addInvocation(.p_weakProperty_set(.value(newValue))); __p_weakProperty = newValue }
	}
	private var __p_weakProperty: (AnyObject)?

    public var propertyGetOnly: String {
		get {	addInvocation(.p_propertyGetOnly_get); return __p_propertyGetOnly ?? givenGetterValue(.p_propertyGetOnly_get, "SimpleProtocolThatInheritsOtherProtocolsMock - stub value for propertyGetOnly was not defined") }
	}
	private var __p_propertyGetOnly: (String)?

    public var propertyOptional: Int? {
		get {	addInvocation(.p_propertyOptional_get); return __p_propertyOptional ?? optionalGivenGetterValue(.p_propertyOptional_get, "SimpleProtocolThatInheritsOtherProtocolsMock - stub value for propertyOptional was not defined") }
		set {	addInvocation(.p_propertyOptional_set(.value(newValue))); __p_propertyOptional = newValue }
	}
	private var __p_propertyOptional: (Int)?

    public var propertyImplicit: Int! {
		get {	addInvocation(.p_propertyImplicit_get); return __p_propertyImplicit ?? optionalGivenGetterValue(.p_propertyImplicit_get, "SimpleProtocolThatInheritsOtherProtocolsMock - stub value for propertyImplicit was not defined") }
		set {	addInvocation(.p_propertyImplicit_set(.value(newValue))); __p_propertyImplicit = newValue }
	}
...
open class SimpleProtocolWithBothMethodsAndPropertiesMock: SimpleProtocolWithBothMethodsAndProperties, Mock {
    ...
    public var property: String {
		get {	addInvocation(.p_property_get); return __p_property ?? givenGetterValue(.p_property_get, "SimpleProtocolWithBothMethodsAndPropertiesMock - stub value for property was not defined") }
	}
	private var __p_property: (String)?
...
open class SimpleProtocolWithPropertiesMock: SimpleProtocolWithProperties, Mock {
    ...
    public var property: String {
		get {	addInvocation(.p_property_get); return __p_property ?? givenGetterValue(.p_property_get, "SimpleProtocolWithPropertiesMock - stub value for property was not defined") }
		set {	addInvocation(.p_property_set(.value(newValue))); __p_property = newValue }
	}
	private var __p_property: (String)?

    public var weakProperty: AnyObject! {
		get {	addInvocation(.p_weakProperty_get); return __p_weakProperty ?? optionalGivenGetterValue(.p_weakProperty_get, "SimpleProtocolWithPropertiesMock - stub value for weakProperty was not defined") }
		set {	addInvocation(.p_weakProperty_set(.value(newValue))); __p_weakProperty = newValue }
	}
	private var __p_weakProperty: (AnyObject)?

    public var propertyGetOnly: String {
		get {	addInvocation(.p_propertyGetOnly_get); return __p_propertyGetOnly ?? givenGetterValue(.p_propertyGetOnly_get, "SimpleProtocolWithPropertiesMock - stub value for propertyGetOnly was not defined") }
	}
	private var __p_propertyGetOnly: (String)?

    public var propertyOptional: Int? {
		get {	addInvocation(.p_propertyOptional_get); return __p_propertyOptional ?? optionalGivenGetterValue(.p_propertyOptional_get, "SimpleProtocolWithPropertiesMock - stub value for propertyOptional was not defined") }
		set {	addInvocation(.p_propertyOptional_set(.value(newValue))); __p_propertyOptional = newValue }
	}
	private var __p_propertyOptional: (Int)?

    public var propertyImplicit: Int! {
		get {	addInvocation(.p_propertyImplicit_get); return __p_propertyImplicit ?? optionalGivenGetterValue(.p_propertyImplicit_get, "SimpleProtocolWithPropertiesMock - stub value for propertyImplicit was not defined") }
		set {	addInvocation(.p_propertyImplicit_set(.value(newValue))); __p_propertyImplicit = newValue }
	}
	private var __p_propertyImplicit: (Int)?
...
open class ThrowingVarProtocolMock: ThrowingVarProtocol, Mock {
    ...
    @available(iOS 15.0.0, macOS 12.0.0, tvOS 15.0.0, *)
		...
		get {	addInvocation(.p_testVariableThatThrow_get); return __p_testVariableThatThrow ?? givenGetterValue(.p_testVariableThatThrow_get, "ThrowingVarProtocolMock - stub value for testVariableThatThrow was not defined") }
	}
...
open class ComposedServiceMock: ComposedService, Mock {
    ...
    public var youCouldOnlyGetThis: String {
		get {	addInvocation(.p_youCouldOnlyGetThis_get); return __p_youCouldOnlyGetThis ?? givenGetterValue(.p_youCouldOnlyGetThis_get, "ComposedServiceMock - stub value for youCouldOnlyGetThis was not defined") }
	}
	private var __p_youCouldOnlyGetThis: (String)?
